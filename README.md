...
**Festival Schedule Page**
  ...
  - Concert Band Festival: Tuesday, November 18, 2025
...
- [ ] The pages’ content must be organized and laid out using content blocks as demonstrated in the flexbox and responsive layouts assignments.
- [ ] A google map embed or a video
- [ ] a web table
- [ ] a web form that includes at least 5 types of form controls (inputs).
